"""
StockX Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from StockX.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/stockx
"""
...
# Set your Web Scraper ID after building your StockX scraper:
# https://bright.cn/products/web-scraper/stockx
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your StockX scraper at: https://bright.cn/products/web-scraper/stockx\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of StockX product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover StockX products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a StockX category page.

    Example:
        results = discover_by_category("https://stockx.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://stockx.com/sample-sneaker-size-10",
        # Add more StockX product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "stockx_prices.json"
    ...
    # cat_results = discover_by_category("https://stockx.com/category/sample", limit=50)
